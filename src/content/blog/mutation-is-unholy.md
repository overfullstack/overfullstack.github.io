...
[Huh? to Aha! - A Refactoring Story](/posts/huh-to-aha/)
...
- As they expected, there were no problems reported. Another day! the developer of `getEggLayingDate` felt there is an opportunity to optimize his DB heavy component and so implemented caching like this.
...
![pointers-everywhere](/images/posts/mutation-is-unholy/media/sof.png)
...
![concurrent-mind](/images/posts/mutation-is-unholy/media/ides-brain-distractions.png)
