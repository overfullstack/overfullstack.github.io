...
![refactoring-def](/images/posts/huh-to-aha/media/refactoring-def.png)
...
![lego-pieces](/images/posts/huh-to-aha/media/legos.jpeg)
...
![flow](/images/posts/huh-to-aha/media/flow.png)
...
![partial-failures](/images/posts/huh-to-aha/media/partial-failures.png)
...
![partial-failures-with-either-1](/images/posts/huh-to-aha/media/either.png)

- Either is switched from `right` to `left` state if it fails downstream.

![partial-failures-with-either-2](/images/posts/huh-to-aha/media/either-validate.png)
