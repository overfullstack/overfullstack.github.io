...
![Intro](/images/posts/monads-for-drunken-coders-pint-1/media/introduction.gif)
...
```java title="cyclomaticeggvalidator.java" {8-10,18,23,26}
void cyclomaticCode() {
...
- State being pin-balled among imperative control statements, function calls and try-catches, is a horror show, when trying to reason-out the code flow or debug it. ![octopus](/images/posts/monads-for-drunken-coders-pint-1/media/octopus.gif)
...
```java title="imperativelastname.java" {3,4,5,6,7,10,11}
...
- He is taking too much of control over iterating and filtering stuff, and as Uncle Ben says, **With great Power comes great Responsibility**. ![uncle-ben](/images/posts/monads-for-drunken-coders-pint-1/media/uncle-ben.gif)
...
- State should always march **Unidirectional**, like an unstoppable army of zombies. ![zombies](/images/posts/monads-for-drunken-coders-pint-1/media/zombies.gif)
...
```java title="functionallastname.java" {6,7,8}
...
- This is flexible to restructure, and it's easy to hire and fire these criterion functions, without thinking too much. ![lego](/images/posts/monads-for-drunken-coders-pint-1/media/lego.gif)
...
- Unidirectional flow demands uniform data structure for the entire stream-per-step. A pipeline can have different types of streams, but how can a stream/collection have different data types? ![color-eggs](/images/posts/monads-for-drunken-coders-pint-1/media/color-eggs.gif)
...
```java title="pseudovalidator.java" {11,14,17,20}
...
![minions](/images/posts/monads-for-drunken-coders-pint-1/media/minions.gif)
...
- Finally! the Dawn of Monad (Introducing the title lead with a BGM) ![dawn-of-justice](/images/posts/monads-for-drunken-coders-pint-1/media/dawn-of-justice.gif)
...
- Now, Orchestrator only has one job to do, just pump the data inside the pipeline ahead to the next validation function. ![wow](/images/posts/monads-for-drunken-coders-pint-1/media/wow.gif)
...
Now you see it? Now you don't? ![now-you-see-me](/images/posts/monads-for-drunken-coders-pint-1/media/now-you-see-me.gif)
