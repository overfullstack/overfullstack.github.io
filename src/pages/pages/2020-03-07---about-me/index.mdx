...
- [**ReVoman 🦹🏻‍♀️**](https://github.com/salesforce-misc/ReVoman), a Template-Driven API Automation tool for JVM.
- [**Vador🦾**](https://github.com/salesforce-misc/Vador), a Validation framework for JVM.
